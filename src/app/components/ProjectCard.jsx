...
const ProjectCard = ({ imgUrl, projectTitle, projectDescription }) => {
  return (
    <div>
      <div
      ...
      >
        <div className="overlay items-center justify-center absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500">
            <Link href="#" className="mr-3 h-14 w-14 border-2 border-white relative rounded-full hover:border-opacity-80 group/link">
            ...
            <Link href="#" className="h-14 w-14 border-2 border-white relative rounded-full hover:border-opacity-80 group/link">
      ...
      <div className="text-white rounded-b-xl bg-[#181818] py-6 px-4">
        ...
        <p className="text-[#adb7BE]">{projectDescription}</p>
      </div>
    </div>
  );
};
